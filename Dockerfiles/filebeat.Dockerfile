FROM docker.elastic.co/beats/filebeat-oss:9.5.0
...
ARG FILEBEAT_FILESCAN_LOG_PATH="/filescan"
...
ARG FILEBEAT_MAIN_LOGS=true
ARG FILEBEAT_ZEEK_FILE_LOGS=true
...
ENV FILEBEAT_FILESCAN_LOG_PATH=$FILEBEAT_FILESCAN_LOG_PATH
ENV FILEBEAT_SURICATA_LOG_PATH=$FILEBEAT_SURICATA_LOG_PATH
ENV FILEBEAT_NGINX_LOG_PATH=$FILEBEAT_NGINX_LOG_PATH
ENV FILEBEAT_MAIN_LOGS=$FILEBEAT_MAIN_LOGS
ENV FILEBEAT_ZEEK_FILE_LOGS=$FILEBEAT_ZEEK_FILE_LOGS
